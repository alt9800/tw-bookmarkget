...
redirect_uri = "https://www.example.com" # 書き換えポイント
...
while "next_token" in json_response.get("meta", {}):
    ...
    user_id = user_me["data"]["id"]
    url = "https://api.twitter.com/2/users/{}/bookmarks".format(user_id) + "?pagination_token=" + json_response["meta"]["next_token"] # ←ここがポイント
    headers = {
        "Authorization": "Bearer {}".format(access),
        "User-Agent": "BookmarksSampleCode",
    }
